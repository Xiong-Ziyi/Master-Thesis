...
Given the parameters above, the initial system's lens data can be derived using equations provided in \textit{Laser Beam Shaping Techniques} (for the calculations, please refer to the \texttt{ZOS\_Galilean\_Beam\_Shaper.ipynb} file):
...
The merit function for optimization can be written in Python as:
