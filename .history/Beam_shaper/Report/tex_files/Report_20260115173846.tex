...
Given the parameters above, the initial system's lens data can be derived using equations provided in \textit{Laser Beam Shaping Techniques} (for the calculations):
