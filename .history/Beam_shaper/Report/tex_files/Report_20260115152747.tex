...
\begin{equation}
    G = \left(\frac{r_max}{\omega_0}\right)
\end{equation}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Keplerian_init.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Keplerian_init_profile.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Keplerian_opted_k_profile.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Keplerian_opted_to_4th.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Keplerian_opted_to_4th_profile.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Keplerian_opted_to_6th.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Keplerian_opted_to_6th_profile.png}
