...
Since the Galilean type beam shaper can not result in a 1:1 beam size conversion, and for making a better comparison, the $R_max$ is timed by 3 to make the marginal ray bend the same size of angle with respect to the optical axis but in an opposite direction.
