...
        approx (bool): indicates if the Longitudinal Aberration is approximated by parabolic function and Taylor expansion.
    '''
    
    def __init__(self, 
                 omega_0: float, 
...
        '''
        Returns the object distance after the first lens at different ray height, given by Equation 7.16.
        '''
...
        '''
        Returns paraxial object distance, which is also equal to effective focal length f_1, given by Equation 7.17 and 7.18.
        '''
        if self.approx:
...
        '''
        Returns the difference between real object distance and paraxial object distance, which is actually Longitudinal Aberration (LA), given by Equation 7.19, 7.20 and 7.21.
        '''
        if self.approx:
            coeff = self._B * self.d /(np.sqrt(2)*(self.omega_0 - np.sqrt(2) * self._B)**2)
            return coeff * self.omega_0**2
        else: 
