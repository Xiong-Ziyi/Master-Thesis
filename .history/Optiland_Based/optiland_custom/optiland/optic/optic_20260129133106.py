...
if TYPE_CHECKING:
    import matplotlib.pyplot as plt  # newly added by Ziyi Xiong
...
class Optic:
    ...
    def _initialize_attributes(self):
        ...
        # Extended source, newly added by Ziyi Xiong, adopted from Manuel
    ...
    ############### The following methods are for segmented surface ##############
    
    def set_cv1(self, value: float, surface_number: int):
        """Set the center zone's radius of a segmented surface.

        by Ziyi Xiong 2025/12
        
        Args:
            value (float): The value of the center zone's radius.
            surface_number (int): The index of the surface.

        """
        self._updater.set_cv1(value, surface_number)
        
    def set_cv2(self, value: float, surface_number: int):
        """Set the ring zone's radius of a segmented surface.

        by Ziyi Xiong 2025/12
        
        Args:
            value (float): The value of the ring zone's radius.
            surface_number (int): The index of the surface.

        """
        self._updater.set_cv2(value, surface_number)
        
    def set_k1(self, value: float, surface_number: int):
        """Set the center zone's conic constant of a segmented surface.

        by Ziyi Xiong 2025/12
        
        Args:
            value (float): The value of the center zone's conic constant.
            surface_number (int): The index of the surface.

        """
        self._updater.set_k1(value, surface_number)
        
    def set_k2(self, value: float, surface_number: int):
        """Set the ring zone's conic constant of a segmented surface.

        by Ziyi Xiong 2025/12
        
        Args:
            value (float): The value of the ring zone's conic constant.
            surface_number (int): The index of the surface.

        """
        self._updater.set_k2(value, surface_number)

    ################# The above methods are for segmented surface ##############
    ...
    def draw(
        ...
        Args:
            ...
            distribution (str | None | BaseDistribution): The distribution of rays.
    ...
    #### Methods for source, newly added by Ziyi Xiong 2026/1, adopted from Manuel ####
    
    def set_source(self, source: BaseSource) -> None:
        """Set the extended source for the optical system.

        Args:
            source (BaseSource): The source source object
        """
        self.source = source
        self.ray_tracer.source = source
    ...
    def plot_surface_sag(
        ...
        fig_to_plot_on: plt.Figure = None, # newly added by Ziyi Xiong
        max_extent: float = 5, # newly added by Ziyi Xiong
        num_points_grid: int = 51, # newly added by Ziyi Xiong
        buffer_factor: float = 1.1, # newly added by Ziyi Xiong
    ):
        ...
        viewer.view(surface_index, 
                    y_cross_section, 
                    x_cross_section,
                    fig_to_plot_on, # newly added by Ziyi Xiong
                    max_extent, # newly added by Ziyi Xiong
                    num_points_grid, # newly added by Ziyi Xiong
                    buffer_factor, # newly added by Ziyi Xiong
                    )
