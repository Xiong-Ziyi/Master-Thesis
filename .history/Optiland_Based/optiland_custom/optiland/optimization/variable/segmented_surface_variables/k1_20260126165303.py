"""
Segmented Surface's Center Zone Conic Constant Variable Module

This module contains the K1Variable class, which represents an optimization
variable for the center zone's conic constant of a segmented surface in an
...
class K1Variable(VariableBehavior):
    """
    Variable for the center zone's conic constant (k1) of a segmented surface.
    ...
    def get_value(self):
        """
        Get the current center zone conic constant.

        Returns:
            float: Current conic constant value.
        """
        return self._surfaces.surfaces[self.surface_number].geometry.k1

    def update_value(self, new_value):
        """
        Update the center zone conic constant.

        Args:
            new_value (float): New conic constant value.
        """
        self.optic.set_k1(new_value, self.surface_number)
    ...
    def __str__(self):
        ...
        """
        return f"Center Zone's Conic Constant, Surface {self.surface_number}"
