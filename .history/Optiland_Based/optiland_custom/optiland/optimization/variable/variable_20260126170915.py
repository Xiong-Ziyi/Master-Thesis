...
from optiland.optimization.variable.segmented_surface_variables.cv1 import (
    Cv1Variable,  # newly added by Ziyi Xiong
)
from optiland.optimization.variable.segmented_surface_variables.cv2 import (
    Cv2Variable,  # newly added by Ziyi Xiong
)
from optiland.optimization.variable.segmented_surface_variables.k1 import (
    K1Variable,  # newly added by Ziyi Xiong
)
from optiland.optimization.variable.segmented_surface_variables.k2 import (
    K2Variable,  # newly added by Ziyi Xiong
)
...
class Variable:
    ...
    def _get_variable(self):
        ...
        variable_types = {
            ...
            "cv1": Cv1Variable,  # newly added by Ziyi Xiong
            "cv2": Cv2Variable,  # newly added by Ziyi Xiong
            "k1": K1Variable,  # newly added by Ziyi Xiong
            "k2": K2Variable,  # newly added by Ziyi Xiong
        }
