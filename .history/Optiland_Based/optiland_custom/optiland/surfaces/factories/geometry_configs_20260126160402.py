...
@dataclass
class SegmentedSurfaceConfig(GeometryConfig):
    surface_type: ClassVar[str] = "segmented_surface"
    split_radius: float = 0.0
    co: float = 0.0
    segment_radii: list[float] = field(default_factory=list)
    segment_conics: list[float] = field(default_factory=list)
    segment_coefficients: list[list[float]] = field(default_factory=list)
    tol: float = 1e-6
    max_iter: int = 100
