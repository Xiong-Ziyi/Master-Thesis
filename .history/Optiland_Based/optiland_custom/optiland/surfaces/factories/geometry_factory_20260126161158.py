...
from optiland.geometries import (
    ...
    PlaneGrating,
    PolynomialGeometry,
    SegmentedSurface,  # newly added by Ziyi Xiong
    StandardGeometry,
...
from optiland.surfaces.factories.geometry_configs import (
    ...
    PlaneConfig,
    PolynomialConfig,
    SegmentedSurfaceConfig,  # newly added by Ziyi Xiong
    StandardConfig,
    ToroidalConfig,
    ZernikeConfig,
    config_registry,
...
def _create_segmented_surface(
    cs: CoordinateSystem, config: SegmentedSurfaceConfig
):
    """
    Create a segmented surface geometry
    Args:
        cs (CoordinateSystem): coordinate system of the geometry.
        config (SegmentedSurfaceConfig): configuration of the geometry.
...
geometry_mapper = {
    ...
    "segmented_surface": _create_segmented_surface, # newly added by Ziyi Xiong
