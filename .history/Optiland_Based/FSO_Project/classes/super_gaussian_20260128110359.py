...
class SuperGaussianIrradiance:
    ...
    def __init__(self, 
        ...
        self.coords = self.be.linspace(-self.max_coord, self.max_coord, int(self.num_samples))
    ...
    def plot_cross_section(self):
        ...
        plt.plot(self.coords, y_values, label=f'Super-Gaussian Irradiance (order={self.be.scalar(self.steepness)})')
